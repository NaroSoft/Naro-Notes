...
export default function Modal(props) {
    ...
    return ReactDom.createPortal(
        <div className='fixed inset-10 bg-slate-800 text-white text-lg sm:text-xl flex flex-col'>
            <div className='flex items-center justify-between border-b border-solid border-white-500 p-4'>
            ...
            <div className='p-4 flex flex-col gap-3'>
                <h2 onClick={() => {
                    logout()
                    setOpenModal(false)
                }} className='select-none duration-300 hover:pl-2 cursor-pointer'>Add Contact</h2>
            </div>
